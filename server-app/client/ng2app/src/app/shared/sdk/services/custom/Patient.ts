...
export class PatientApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdDoctors(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors/:fk";
   ...
   */
  public destroyByIdDoctors(id: any, fk: any): Observable<any> {
   ...
   * </em>
   */
  public updateByIdDoctors(id: any, fk: any, data: any = {}): Observable<any> {
   ...
   * </em>
   */
  public linkDoctors(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public unlinkDoctors(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors/rel/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public existsDoctors(id: any, fk: any): Observable<any> {
   ...
   * </em>
   */
  public getDoctors(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createDoctors(id: any, data: any = {}): Observable<any> {
   ...
   * This method returns no data.
   */
  public deleteDoctors(id: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countDoctors(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyDoctors(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/patients/:id/doctors";
    let _routeParams: any = {
