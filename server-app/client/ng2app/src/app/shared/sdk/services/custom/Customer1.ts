...
/**
 * Api services for the `Customer1` model.
 */
@Injectable()
export class Customer1Api extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Customer1` object.)
   * </em>
   */
  public findByIdEmails(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/customer1s/:id/emails/:fk";
